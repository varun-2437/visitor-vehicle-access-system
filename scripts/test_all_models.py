...
def detect_fcos(img, od_model):
    ...
    b = boxes[0] # Use highest confidence
    h, w = img.shape[:2]
    # Add 5% padding to prevent clipping characters (like the '13' in MH12JC2813)
...
def main():
    print("=" * 110)
    print("  ULTIMATE ANPR BENCHMARK — ALL MODELS")
    print("=" * 110)
